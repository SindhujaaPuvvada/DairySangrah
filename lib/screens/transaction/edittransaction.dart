...
class _EditTransactionState extends State<EditTransaction> {
  ...
  initState() {
    ...
    if (widget.showIncome) {
      ...
      _valueController = TextEditingController(
        text: widget.sale?.value.toString(),
      );
  ...
  void _submitForm(BuildContext context) {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (context) => TransactionPage(showIncome: widget.showIncome),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          (widget.showIncome)
              ? '${currentLocalization['edit_income']}'
              : '${currentLocalization['edit_expense']}',
            ...
            children: [
              Container(
                ...
                child: TextFormField(
                  ...
                  initialValue:
                      (widget.showIncome)
                          ? '${currentLocalization[widget.sale?.name] ?? widget.sale?.name}'
                          : '${currentLocalization[widget.expense?.name] ?? widget.expense?.name}',
                  decoration: InputDecoration(
                    labelText:
                        (widget.showIncome)
                            ? '${currentLocalization['income_category']}'
                            : '${currentLocalization['expense_category']}',
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  initialValue:
                      '${_dateOfTransaction.year}-${_dateOfTransaction.month}-${_dateOfTransaction.day}',
                  decoration: InputDecoration(
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText:
                        '${currentLocalization['enter_transaction_amount']}',
                  ),
