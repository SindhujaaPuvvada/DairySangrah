...
class AlertsConstants {
  ...
  static Map<String, String> alertDesc = {
    ...
    "AIA":"due for Insemination", // Artificial Insemination alert
  ...
  static Map<String, List<String>> alertsForPhase = {
    "Pregnant": <String>["NUA", "DRA"],
    "Dry": <String>["HTA","PTA","CVA","MKA"],
    "Milked": <String>["HTA","PTA"],
    "Heifer": <String>["AIA","PTA","DWV","BRV"],
  };
}